...
export const NO_BODY_URLS: string[] = ["/test", "/ok", "/user/delete", "/device/profileImage", "/user/profileImage", "/user/logout", "/test", "/favicon.ico", "/user/resetPassword", "/user/verifyEmail"];

export const BYPASS_URLS: string[] = ["/test", "/ok", "/user/delete", "/user/add", "/user/login", "/user/resetPassword", "/test", "/agent/add", "/customer/add", "/customer/uploadimages", "/old/customer/uploadimages", "/user/uploadprofilephoto", "/favicon.ico", "/user/verifyEmail"];
